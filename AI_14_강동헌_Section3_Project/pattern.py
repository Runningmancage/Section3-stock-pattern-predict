...
class PatternFinder():
    ...
    def search(self, start_date, end_date, threshold=0.96):
    ...
    def plot_pattern(self, idx, period=5):
        ...
        axis.plot(self.base_norm.values, label='base', color='blue',  alpha=0.7)
        ...
        axis.axvline(x=len(self.base_norm)-1, c='green', linestyle='dotted')
